...
<body>
	...
	<div class="container pt100">
		<div class="panel add_loan_contract ">
			...
			<form id="dataForm" action="loanContract/update.html" method="POST"
				...
				<div class="fieldset active">
					<div class="form-group">
						...
						<div class="col-sm-2 required">
							<input class="form-control " name="contractNumber" type="text"
								value="${contract.contractNumber }" readonly="readonly"/>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2 ">
							<input class="form-control" name="signTime" readonly="readonly"
								type="text" value="${contract.signTime }" />
						</div>
						<label class="col-sm-2 control-label col-sm-offset-2">贷款开始日期</label>
						<div class="col-sm-2 ">
							<input class="form-control" name="startDate" readonly="readonly"
					...
					<div class="form-group">
						...
						<div class="col-sm-2 ">
							<input class="form-control" name="endDate" readonly="readonly"
					...
					<div class="form-group">
						...
						<div class="col-sm-2 ">
							<div class="input-group ">
								<input type="text" class="form-control" name="term" readonly="readonly"
					...
					<div class="form-group">
						...
						<div class="col-sm-2 ">
							<select name="isEntrust" class="form-control" disabled="disabled">
								<option value="0"
						...
						<div class="col-sm-2 ">
							<select name="repayMethod" class="form-control" disabled="disabled">
												...
												<c:forEach items="${contract.repayPlans }" var="rp"
													...
													<tr>
														<td ><input  type="text" readonly="readonly"
															...
															value="${rp.endDate }" class="dateIcon"></td>
														<td><input type="text" readonly="readonly"
					...
					<div class="form-group last">
						 <span
							class="btn btn-info col-sm-1 col-sm-offset-5 next"
							id="pageOneNext">下一步</span>
							<span
							class="btn btn-info col-sm-1 col-sm-offset-1 submitBtn" >完成</span>
					</div>
				</div>
				...
				<div class="fieldset ">
					...
					<div class="form-group last mt30">
						 <span
							class="btn btn-info col-sm-1 col-sm-offset-3 prev"
				...
				<div class="fieldset">
												...
												<c:otherwise>
													<c:forEach items="${contract.pledgeContracts }" var="pc"
														...
														<tr>
															...
															<td><input type="text"
																name="pledgeContracts[${statu.index }].address" value="${pc.address }"
																class="form-control"></td>
															<td><select
					...
					<div class="form-group last">
						 <span
							class="btn btn-info col-sm-1 col-sm-offset-4 prev"
